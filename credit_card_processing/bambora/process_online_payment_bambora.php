...
// Uses Bambora to perform the online payment returning confirmation 
function processOnlinePaymentBambora($order_num , $order_name , $payment_amount 
                                  , $transact_type , $cc_info , $cu_contact_id = null)
{
  ...
  curl_setopt($curl_obj,CURLOPT_URL,"https://web.na.bambora.com/scripts/process_transaction.asp");
