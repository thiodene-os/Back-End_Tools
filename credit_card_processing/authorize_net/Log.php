...
// Just for removing the line: file_put_contents($this->logFile, $logString, $flags);
// This stopped the transaction no need of Log files...
...
class Log
{
	...
	*/
	...
	private function log($logLevelPrefix, $logMessage, $flags){
        ...
        //debug($this->logFile,"this->logFile","File: " . __FILE__ . " Line: " . __LINE__) ;
        
        // Remove this logfile save not to stop the script! (Serge: 2018-02-15)
